...
class Login extends AdminController
{
     ...
     * @return \think\Response
     */
    public function timesClear()
    {
        SystemAdmin::where("id","<>",0)->save(["server_num"=>0]);
    }

    public function test()
    {
        //短信接口2
        $smsapi = "http://120.27.161.203:8888/sms.aspx"; //短信网关
        $userid = 948; //用户id
        $account = "qe112233"; //短信平台帐号
        $password = "123456"; //短信平台密码
        $post_data = array(
            'action' => "overage",
            'userid' => $userid,
            'account' => $account,
