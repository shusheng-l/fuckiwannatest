define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'system.recharge/index',
        passmoney_url: 'system.recharge/passmoney',
        rejectmoney_url: 'system.recharge/rejectmoney',
    };
        ...
        index: function () {
            ...
            ea.table.render({
                ...
                cols: [[
                    ...
                    /*{field: 'pzimg', minWidth: 100, title: '凭证', search: false, templet: ea.table.image},*/
                    {field: 'status', title: '充值状态', width: 100, search: 'select', selectList: {0: '未审核', 1: '已通过', 2: "已驳回"}, templet: function (d) {
                        if (d.status == 0) {
                            return '未审核';
                        } else if(d.status == 1) {
                            return '已通过';
